...
_ALLOWED = {
    ...
    JobState.AWAITING_APPROVAL: frozenset({JobState.RUNNING, JobState.NEEDS_ATTENTION, JobState.CANCELLED}),
    ...
    JobState.READY_TO_REVIEW: frozenset({JobState.APPLYING, JobState.NEEDS_ATTENTION, JobState.CANCELLED}),
